...
sub getCommentString
{
    ...
    {
	print "Warning: can not determine a comment token for the file $filename\n";
    }
...
foreach my $choice ( @choices )
{
    ...
    {
	my $sourceFile = $GT_DIR."/".$choice_conf->{"File"};
	...
	{
	    $modules_to_load{$file} .= "source $sourceFile\n";
	}
